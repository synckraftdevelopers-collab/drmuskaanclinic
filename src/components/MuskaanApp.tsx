...
import {
  Sparkles, HeartPulse, Activity, CalendarCheck, Clock, MapPinned, PhoneCall,
  ChevronRight, Star, HelpCircle, Bot, X, ShieldCheck, Award,
  MessageCircle, Users, Trash2, CheckCircle2, ChevronDown, ChevronLeft, ChevronRight as ChevronRightIcon
} from "lucide-react";
          ...
          <div className="max-w-7xl mx-auto flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
            ...
            >
              <div className="relative flex items-center justify-center mr-2.5">
                <div 
                  className="absolute -top-0.5 -left-1 w-1.5 h-1.5 rounded-full bg-[#22C55E]"
            ...
            <motion.div variants={staggerContainer} initial="hidden" animate="visible" className="space-y-16 w-full">
              ...
              >
                ...
                <motion.div
                  ...
                  className="absolute -top-20 -left-20 w-[28rem] h-[28rem] bg-slate-teal/5 rounded-full blur-3xl pointer-events-none"
                />
                <motion.div
                  animate={shouldReduceMotion ? {} : {
                    x: [0, 50, -40, 0],
                  ...
                  className="absolute top-1/3 -left-20 w-[28rem] h-[28rem] bg-seafoam/5 rounded-full blur-3xl pointer-events-none"
                />
                <motion.div
                  animate={shouldReduceMotion ? {} : {
                    x: [0, -50, 40, 0],
                  ...
                  className="absolute top-1/3 -right-20 w-[28rem] h-[28rem] bg-seafoam/5 rounded-full blur-3xl pointer-events-none"
                />
                <motion.div
                  animate={shouldReduceMotion ? {} : {
                    x: [0, 30, -40, 0],
