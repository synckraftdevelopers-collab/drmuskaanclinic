        ...
        <div className="max-w-7xl mx-auto flex justify-between items-center text-[14px] lg:text-[15px] leading-[1.5] tracking-[0.2px]">
          <div className="flex items-center md:space-x-[40px] lg:space-x-[56px]">
            <span className="flex items-center space-x-[10px] group transition-colors duration-[250ms] cursor-default">
              <PhoneCall size={18} className="text-[#F86008] transition-transform duration-[250ms] group-hover:scale-[1.08]" aria-hidden="true" />
            ...
            <span className="flex items-center space-x-[10px] group transition-colors duration-[250ms] cursor-default">
              <Clock3 size={18} className="text-[#F86008] transition-transform duration-[250ms] group-hover:scale-[1.08]" aria-hidden="true" />
              <span className="transition-colors duration-[250ms] text-[rgba(255,255,255,0.85)] group-hover:text-[#FFFFFF]">
          ...
          <div className="flex items-center md:space-x-[40px] lg:space-x-[56px]">
            <span className="flex items-center space-x-[10px] group transition-colors duration-[250ms] cursor-default">
              <MapPinned size={18} className="text-[#F86008] transition-transform duration-[250ms] group-hover:scale-[1.08]" aria-hidden="true" />
            ...
            <span className="flex items-center space-x-[10px] group transition-colors duration-[250ms] cursor-default">
              <ShieldCheck size={18} className="text-[#F86008] transition-transform duration-[250ms] group-hover:scale-[1.08]" aria-hidden="true" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex justify-between items-center">
        ...
        >
          <Image 
            ...
            width={640} 
            height={400} 
            className="h-[68px] sm:h-[80px] w-auto -my-2 sm:-my-4 object-contain object-left transition-transform group-hover:scale-105"
            priority
            quality={100}
          />
        </div>
            ...
            <nav className="flex flex-col space-y-4">
              ...
              <div className="pt-4 border-t border-linen flex flex-col space-y-3">
                <button
                  ...
                  className="flex items-center justify-center space-x-2 bg-gradient-to-r from-slate-teal to-ocean-teal hover:from-[#3F0653] hover:to-[#D94F05] text-white font-bold py-3 px-4 rounded-full shadow-[0_4px_14px_rgba(80,8,104,0.22)] hover:shadow-[0_6px_20px_rgba(248,96,8,0.28)] transition-all duration-300 transform hover:-translate-y-1 hover:scale-102 group text-sm cursor-pointer"
